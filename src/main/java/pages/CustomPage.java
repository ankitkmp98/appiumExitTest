...
public class CustomPage extends BaseTest {
	...
	public void custom_button() {
		wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
				By.xpath("//android.widget.TextView[@content-desc=\"Custom Evaluator\"]")));
	...
	public MobileElement custom_page_title;

	public String custom_page_title() {
		String result = custom_page_title.getText();
		return result;
	}
